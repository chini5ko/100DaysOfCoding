...
bot.on('message', async function(msg) {
  ...
  if (receiver.id === 'filehelper') {
    ...
    else if (text === '#wander') { //lines added by Chini5ko
      busyIndicator = true
      await filehelper.say('Wander Mode ON')
      busyOn = "wander";
    }
  ...
  if (!room) {
    ...
    if(busyOn=='wander'){
      busyAnnouncement = 'Currently, Hector is wandering around the city. He will get back to you as soon as he stop wandering'
    }
